...
finetune_model.save_weights("Final_model_webcam.weights.h5")
finetune_model.load_weights("Final_model_webcam.weights.h5")
...
# finetune_model.load_weights("Final_model4.weights.h5")

pickle.dump(finetune_model,open('mil_webcam.pkl','wb'))
